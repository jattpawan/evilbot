...
@Client.on_message(command("update") & other_filters)
@errors
...
async def upstream(ups):
    ...
    if force_updateme:
        ...
        await ups.edit('`Updating your` **ßot** `please wait for 5 mins then type .alive/.ping/.help/.test to see if I am On...`')
